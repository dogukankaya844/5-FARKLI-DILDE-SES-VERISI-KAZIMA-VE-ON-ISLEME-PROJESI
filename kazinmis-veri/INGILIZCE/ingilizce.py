...
calma_listesi_id = "PLS3XGZxi7cBXnYfJpUas1ud6XATvWATHb"
...
ingilizce_videolar = calma_listesinden_videolari_al(calma_listesi_id, maksimum_sonuc=5000) #playlist'teki videolar alınır. 
#playlist_id ve max_results parametreleri kullanılarak istenilen video sayısı alınır.

# Çıktı dizini
cikti_dizini = "C:\\Users\\Niyazi\\Desktop\\kazinmis-veri\\INGILIZCE\\ingilizce-ham"  # Çıktı dizinini buraya yazın

# Her bir videoyu indir ve 1 dakikalık MP3 olarak kaydet
for video in ingilizce_videolar: #german_videos listesindeki her bir video için döngü başlatılıyor.
